Проект по базовому анализу данных из датасета "bookings.csv" о бронировании номеров в отелях.
...
0. Подготовка данных (не выводится): загрузка csv с разделителем ; , нормалицация имен столбцов.
...
8. Посчитайте отношение количества ушедших пользователей к общему количеству клиентов, выраженное в процентах (churn rate).
    Укажите, среди какой группы (с детьми или без) показатель выше.
